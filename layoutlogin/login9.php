                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="index.php?act=dangnhap" method="post">
                            <input class="form-control" type="text" name="tendangnhap" placeholder="E-mail Address" required>
                            <input class="form-control" type="password" name="matkhau" placeholder="Password" required>
                            <div class="form-button">
                                <input id="submit" type="submit" name="dangnhap" class="ibtn" value="Đang nhập"></input> <a href="dangky.php">Forget password?</a>
                            </div>
                        </form>
