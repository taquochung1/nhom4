<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from wrraptheme.com/templates/hexabit/html/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 15:54:23 GMT -->
  <head>
    ...
    <link
      rel="stylesheet"
      href="../view/assets/vendor/font-awesome/css/font-awesome.min.css"
    />

    <link rel="stylesheet" href="../view/assets/vendor/charts-c3/plugin.css" />
    <link
      rel="stylesheet"
      href="../view/assets/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
    />
    <link
      rel="stylesheet"
      href="../view/assets/vendor/chartist/css/chartist.min.css"
    />
    <link
      rel="stylesheet"
      href="../view/assets/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css"
    />
    <link rel="stylesheet" href="../view/assets/vendor/toastr/toastr.min.css" />

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="../view/light/assets/css/main.css" />
    <link rel="stylesheet" href="../view/light/assets/css/color_skins.css" />
  </head>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="body">
                      ...
                      <small class="text-muted"
                        >19% compared to last week</small
                      >
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="body">
                  <div class="row clearfix">
                    ...
                    <div class="col-7">
                      ...
                      <span
                        >Wallet Ballance
                        <span class="float-right">8920$</span></span
                      ><br />
                      <span>Travels <span class="float-right">920$</span></span
                      ><br />
                      <span
                        >Foods & Drinks
                        <span class="float-right">120$</span></span
                      >
                    </div>
                  </div>
                </div>
                      ...
                      <a href="javascript:void(0);">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <span class="name"
                              >@Alexander
                              <small class="float-right">1 day ago</small></span
                            >
                            <span class="message"
              ...
              <div class="card">
                ...
                <div class="body social_counter">
                  <ul class="list-unstyled basic-list">
                    <li>
                      <i class="fa fa-facebook-square m-r-5"></i> FaceBook
                      <span class="badge badge-primary">16,785</span>
                    </li>
                    <li>
                      <i class="fa fa-twitter-square m-r-5"></i> Twitter
                      <span class="badge-purple badge">2,365</span>
                    </li>
                    <li>
                      <i class="fa fa-linkedin-square m-r-5"></i> Linkedin<span
                        class="badge-success badge"
                        >9,021</span
                      >
                    </li>
                    <li>
                      <i class="fa fa-google-plus-square m-r-5"></i> Google
                      Plus<span class="badge-info badge">725</span>
                    </li>
                    <li>
                      <i class="fa fa-behance-square m-r-5"></i> Behance<span
                        class="badge-info badge"
                        >1,725</span
                      >
                    </li>
                    <li>
                      <i class="fa fa-dribbble m-r-5"></i> Dribbble<span
                        class="badge-info badge"
                        >11,725</span
                      >
                    </li>
