<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demos.webicode.com/html/eco-shop-html/Single_Img_Demo/about-us_01.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 14:38:36 GMT -->
<!-- Added by HTTrack -->
  ...
  <div id="wrap">
    ...
    <div id="content">
              ...
              <div class="vision-text">
                ...
                <div class="col-lg-7">
                  <p>
                    ...
                    luctus. <br />
                    <br />
                    Morbi ac scelerisque mauris. Etiam sodales a nulla ornare
                    viverra. Nunc at blandit neque, bibendum varius purus. Nam
                    sit amet sapien vitae enim vehicula tincidunt. Cum sociis
        ...
        <div class="position-center-center">
          <div class="container">
            <div class="col-sm-6 center-block">
              ...
              <p>
                Phasellus lacinia fermentutm bibendum. Interdum et malante
                ipuctus non. Nulla lacinia, eros vel fermentum consectetur,
                ris dolor in ex.
              </p>
            </div>
          </div>
      ...
      <section class="video-block">
        ...
        <div class="position-center-center">
          <a href="#"> <i class="icon-camcorder"></i>watch video </a>
        </div>
      </section>
          ...
          <ul class="row">
            ...
            <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.4s">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-1.jpg" alt="" />
                  <!-- Team hover -->
            ...
            <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.6s">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-2.jpg" alt="" />
                  <!-- Team hover -->
                  <div class="team-hover">
                    <div class="position-center-center">
                      <div class="social-icons">
            ...
            <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.8s">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-3.jpg" alt="" />
                  <!-- Team hover -->
                  <div class="team-hover">
                    <div class="position-center-center">
                      <div class="social-icons">
            ...
            <li class="col-md-4 text-center">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-4.jpg" alt="" />
                  <!-- Team hover -->
                  <div class="team-hover">
                    <div class="position-center-center">
                      <div class="social-icons">
            ...
            <li class="col-md-4 text-center">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-5.jpg" alt="" />
                  <!-- Team hover -->
                  <div class="team-hover">
                    <div class="position-center-center">
                      <div class="social-icons">
            ...
            <li class="col-md-4 text-center">
              <article>
                <!-- abatar -->
                <div class="avatar">
                  <img class="img-circle" src="images/team-6.jpg" alt="" />
                  <!-- Team hover -->
                  <div class="team-hover">
                    <div class="position-center-center">
                      <div class="social-icons">
        ...
        <div class="container">
          <div class="col-md-8 center-block">
            ...
            <p>
              ...
              fames ac ante ipsumien lacus, eu posuere eros vel fermentum
              consectetur, risus purus tempc, et iaculis odio dolor in ex.
            </p>
            <span><span class="primary-color">@johnsmith</span> 4 hours ago via
              Twitter</span>
          </div>
        </div>
      </section>
      ...
      <section class="our-team padding-top-150 padding-bottom-100">
        <div class="container">
          ...
          <ul class="clients-img">
            ...
            <li>
              <img class="img-responsive" src="images/c-img-2.jpg" alt="" />
            </li>
            <li>
              <img class="img-responsive" src="images/c-img-3.jpg" alt="" />
            </li>
            <li>
              <img class="img-responsive" src="images/c-img-4.jpg" alt="" />
            </li>
          </ul>
        </div>
      </section>
      ...
      <section class="news-letter padding-top-150 padding-bottom-150">
        <div class="container">
          <div class="heading light-head text-center margin-bottom-30">
            <h4>NEWSLETTER</h4>
            <span>Phasellus lacinia fermentum bibendum. Interdum et malesuada
...
<!-- Mirrored from demos.webicode.com/html/eco-shop-html/Single_Img_Demo/about-us_01.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2023 14:38:39 GMT -->
