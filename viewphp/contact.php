...
<body>
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <div id="contact_message" class="success-msg">
                  <i class="fa fa-paper-plane-o"></i>Thank You. Your Message
                  has been Submitted
                </div>
                ...
                <form role="form" id="contact_form" class="contact-form" method="post" onSubmit="return false">
                  <ul class="row">
                    ...
                    <li class="col-sm-12">
                      <button type="submit" value="submit" class="btn" id="btn_submit" onClick="proceed();">
                        Gửi tin nhắn
                      </button>
                    </li>
                  </ul>
                ...
                <div class="contact-info">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <a href="mailto:someone@example.com" target="_top">info@ecoshop.com</a>
                    </li>
                    <li>
                      <!-- <p>
  ...
  <script type="text/javascript">
    ...
    function initialize_map() {
      if ($("#map").length) {
        var myLatLng = new google.maps.LatLng(21.0239697, 105.8089983);
        var mapOptions = {
          zoom: 17,
          center: myLatLng,
          scrollwheel: false,
